...
创建主角 node_img = MK_主角 node_img $ 创建节点集 (MK_坐标 250 300) node_img -- 下身
                                        [ 创建子节点集 (MK_坐标 250 200) node_img 100 (-90-20, -90+20) -- 上身
                                            [ 创建子节点集 (MK_坐标 130 300) node_img 60 (120, 240) [ 创建子节点集 (MK_坐标 85 350) node_img 60 (70, 290) [] ] -- 左手
                                            , 创建子节点集 (MK_坐标 350 300) node_img 60 (-60, 60) [ 创建子节点集 (MK_坐标 400 350) node_img 60 (-110, 110) [] ] -- 右手
                                            , 创建子节点集 (MK_坐标 250 170) node_img 30 (-90-10, -90+10) [] -- 头
                                            ]
                                        , 创建子节点集 (MK_坐标 180 510) node_img 70 (100, 180) [ 创建子节点集 (MK_坐标 130 620) node_img 70 (60, 180) [] ] -- 左腿
                                        , 创建子节点集 (MK_坐标 300 510) node_img 70 (0, 80) [ 创建子节点集 (MK_坐标 340 620) node_img 70 (0, 120) [] ] -- 右腿
                                        ]
