...
初始状态 = do
    ...
    newRef $ MK_状态 { 系统信息 = 创建系统信息
                     ...
                     , 测试节点集 = 创建节点集 (MK_坐标 250 300) node_img -- 下身
                                    [ 创建子节点集 (MK_坐标 250 200) node_img 100 (-90-10, -90+10) -- 上身
                                      [ 创建子节点集 (MK_坐标 130 300) node_img 60 (120, 180) [ 创建子节点集 (MK_坐标 85 350) node_img 60 (90, 270) [] ] -- 左手
                                      , 创建子节点集 (MK_坐标 350 300) node_img 60 (0, 60) [ 创建子节点集 (MK_坐标 400 350) node_img 60 (-90, 90) [] ] -- 右手
